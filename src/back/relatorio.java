...
public class relatorio extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Valor total diário R$ ");
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(valor_total_diario, javax.swing.GroupLayout.PREFERRED_SIZE, 114, javax.swing.GroupLayout.PREFERRED_SIZE)))
    ...
    private void buscarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buscarButtonMouseClicked
        ...
        try {
            while (rs.next()) {
                ...
                valor_total.add(rs.getDouble("valor_total"));
            }
        ...
        String soma;
        for (int i = 0; i < valor_total.size(); i++) {
            soma = valor_total.get(i).toString();
            valorFinalTotal = valorFinalTotal + Double.valueOf(soma);
        }
        ...
        valor_total_diario.setText(String.valueOf(formatoDois.format(valorFinalTotal)));
